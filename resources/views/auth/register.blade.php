...
<body class="gradient-bg min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full animate-fade-in">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl sm:text-4xl font-bold text-white mb-2">Join LocalMind</h1>
            <p class="text-sm sm:text-base text-gray-200">Create an account and start sharing knowledge</p>
        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" required 
                                    class="w-full pl-10 pr-4 py-2 sm:py-3 rounded-lg border border-gray-300 focus:ring-purple-500 focus:border-purple-500 input-focused"
